  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <main className="w-full h-screen relative">
        ...
        <div
  className="w-full h-screen bg-noise bg-repeat z-20 absolute  opacity-5 inset-0 "
        ...
        <div className="w-full h-[550px] flex justify-center items-center flex-col gap-8">
          <div>
            <h2 className=" text-[50px] font-mono text-center font-bold">
              Streamline Bounty Management <br className="hidden md:block" /> for GitHub Repositories
            </h2>
            <p className="text-[16px] font-mono text-center mx-auto px-20 mt-2">
              ...
              requests. Sign in, set up your payment details, and <br className="hidden md:block"/>
              get rewarded for your contributions.
            </p>
          </div>
          <div className="flex flex-row justify-between items-center gap-7">
            <Button variant={"outline"} size={"lg"}className="border-yellow-600 border-2 bg-yellow-600 bg-opacity-20">Give Bounty</Button> 
            <Button  variant={"outline"} size={"lg"} className="border-green-600 border-2 bg-green-600 bg-opacity-20">To Claim Bounty</Button>
          </div>
        </div>
      </main>
    </div>
